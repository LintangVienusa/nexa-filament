...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::connection('mysql_inventory')->table('HomeConnect', function (Blueprint $table) {
            ...
            $table->string('port_odp','25')->nullable()->after('odp_name');
            $table->string('merk_ont','25')->nullable()->after('port_odp');
    ...
    {
         Schema::connection('mysql_inventory')->table('HomeConnect', function (Blueprint $table) {
            $table->dropColumn(['merk_ont','id_pelanggan', 'name_pelanggan', 'port_odp', 'foto_label_id_plg','foto_qr']);
        });
    }
};
