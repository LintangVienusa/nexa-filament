    ...
    <div
        x-data="{
            ...
            getImageUrl(path) {
                ...
                // Only prepend the URL prefix if it's a path and not already a full URL
            ...
            async getCameras() {
                try {
                    ...
                    if (this.availableCameras.length > 0 && !this.selectedCameraId) {
                        // Default to the first camera (usually front-facing on mobile)
            ...
            async initWebcam() {
                ...
                if ({{ $getShowCameraSelector() ? 'true' : 'false' }} && this.availableCameras.length === 0) {
                    await this.getCameras();
                }
                
                // Calculate aspect ratio for constraints
                let aspectWidth = 16;
                let aspectHeight = 9;
            ...
            usePhoto() {
                ...
                // Already set in photoData via entangle
            },
            ...
            flipCamera() {
                ...
                if (this.webcamActive) {
                    ...
                    // Need to wait a moment before restarting
                    setTimeout(() => {
                        this.initWebcam();
                    }, 300);
                }
            ...
            <div class="relative w-20 h-20">
                ...
                <template x-if="photoData">
                    ...
                    >
                        ...
                        <!-- Preview button (visible in both enabled and disabled states) -->
                        <div class="absolute top-0 left-0 p-1 bg-gray-800 bg-opacity-70 rounded-br">
                            <a :href="getImageUrl(photoData)" target="_blank" @click.stop class="block">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
