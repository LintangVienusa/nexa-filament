...
class BastODCExport implements WithEvents
{
    protected $project;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $details = ODCDetail::where('bast_id', $this->project->bast_id)
                    ->where('odc_name', $this->project->odc_name)
                    ->first();
                ...
                $sheet = $event->sheet->getDelegate()->setTitle('IMPLEMENTATION PHOTO ODC');;
                ...
                $range = 'C33:F49';
                    [$startCol, $startRow, $endCol, $endRow] = sscanf($range, "%[A-Z]%d:%[A-Z]%d");
                                    ...
                                    $photoPath = public_path('storage/' . $details->odc_tertutup);
                                    $sheet->setCellValue('C33', '');

                    if (file_exists($photoPath) && $details->odc_tertutup !='' ) {
                        ...
                        $drawing = new Drawing();
                        $drawing->setPath(public_path('storage/' . $details->odc_tertutup));
                        $drawing->setCoordinates($startCol . $startRow);
                        $drawing->setOffsetX(5);
                        $drawing->setOffsetY(5);
                        $drawing->setWidth(190);
                ...
                $sheet->fromArray([
                    [ 'Power Optic From OLT TO '.$details->odc_name],
                ], null, 'H12', true);
                ...
                $range = 'H33:K49';
                    [$startCol, $startRow, $endCol, $endRow] = sscanf($range, "%[A-Z]%d:%[A-Z]%d");
                                    ...
                                    $photoPath = public_path('storage/' . $details->flexing_conduit);
                                    $sheet->setCellValue('H33', '');

                    if (file_exists($photoPath) && $details->flexing_conduit !='' ) {
                        ...
                        $drawing = new Drawing();
                        $drawing->setPath(public_path('storage/' . $details->flexing_conduit));
                        $drawing->setCoordinates($startCol . $startRow);
                        $drawing->setOffsetX(5);
                        $drawing->setOffsetY(5);
                ...
                $range = 'M14:P30';
                    [$startCol, $startRow, $endCol, $endRow] = sscanf($range, "%[A-Z]%d:%[A-Z]%d");
                                    ...
                                    $photoPath = public_path('storage/' . $details->odc_terbuka);
                                    $sheet->setCellValue('M14', '');

                    if (file_exists($photoPath) && $details->odc_terbuka !='' ) {
                        ...
                        $drawing = new Drawing();
                        $drawing->setPath(public_path('storage/' . $details->odc_terbuka));
                        $drawing->setCoordinates($startCol . $startRow);
                        $drawing->setOffsetX(5);
                        $drawing->setOffsetY(5);
                        $drawing->setWidth(190);
